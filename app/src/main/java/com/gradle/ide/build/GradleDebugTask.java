...
public class GradleDebugTask extends AsyncTask<Project, String, BuildResult> {
	...
	public GradleDebugTask(Context context) {
	...
	public BuildResult doInBackground(Project... params) {
	    ...
	    try {	
			GradleAssembleDebugTask gradleAssembleDebugTask = new GradleAssembleDebugTask(project);
			gradleAssembleDebugTask.prepare();
			gradleAssembleDebugTask.run();
