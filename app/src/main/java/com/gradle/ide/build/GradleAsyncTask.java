...
public class GradleAsyncTask extends AsyncTask<Project, String, BuildResult> {
	...
	public GradleAsyncTask(Context context) {
	...
	public BuildResult doInBackground(Project... params) {
	    ...
	    try {	
		GradleBuildTask gradleBuild = new GradleBuildTask(project);
			gradleBuild.prepare();
			gradleBuild.run();
